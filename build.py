...
def main():
    # Warning message
    print("Warning: You must have a valid C++ compiler installed and in your PATH.")
    ...
    # Get the C++ compiler from the environment variable CXX
    # compiler = os.getenv('CXX', 'g++')  # Default to g++ if CXX is not set
    compiler = os.getenv('CPP_MINGW_POSIX', 'g++')  # Default to g++ if CXX is not set
